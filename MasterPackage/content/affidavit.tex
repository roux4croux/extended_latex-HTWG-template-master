...
\thispagestyle{plain}%macht nur Seitenzahl und kein Header

%\chapter*{Ehrenw"ortliche Erkl"arung}%alternative welche den Chapterstyle hier schon anwendet.

\vspace*{2cm}
\noindent %sorgt dafür das textanfang nicht leicht eingerückt wird.
